...
from datasets.FedTripletLossDataset import FedTripletFaceDataset
...
def main():
    ...
    for epoch in range(start_epoch, epochs):
        ...
        ) for classes_split in classes_splits]

        for (model, optimizer_model, train_dataloader) in zip(models, optimizer_models, train_dataloaders):
            # Training pass
            model.train()
